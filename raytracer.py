...
rayTracer.scene.append(Sphere(position = (0, 0.2, -7), radius = 1.1, material = snow()))
rayTracer.scene.append(Sphere(position = (0, -1.5, -7), radius = 1.4, material = snow()))
...
rayTracer.scene.append(Sphere(position = (-0.25, 1.4, -5), radius = 0.1, material=  plastic()))
rayTracer.scene.append(Sphere(position = (0.19, 1.13, -4), radius = 0.04, material=  stone()))
rayTracer.scene.append(Sphere(position = (-0.19, 1.13, -4), radius = 0.04, material=  stone()))
