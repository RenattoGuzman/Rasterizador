...
class Renderer(object):
        ...
        for x in range(minX, maxX + 1):
            for y in range(minY, maxY + 1):
                ...
                if (0 <= x < self.width) and (0 <= y < self.height):
                    ...
                    P = (x,y)
                    bCoords = Multi.barycentricCoords(A, B, C, P)
    ...
    def glCamMatrix(self, translate = (0,0,0), rotate = (0,0,0)):
        ...
        self.viewMatrix = Multi.inverse_matrix(self.camMatrix)
          
    def glLookAt(self, camPos = (0,0,0), eyePos = (0,0,0)):
        worldUp = (0,1,0)
        
        forward = Multi.norm_vector(Multi.vecResta(camPos, eyePos))
        right = Multi.norm_vector(Multi.vecMulti(worldUp, forward))
        up = Multi.norm_vector(Multi.vecMulti(forward, right))
    ...
    def glModelMatrix(self, translate = (0,0,0), rotate = (0,0,0), scale = (1,1,1)):
        ...
        return Multi.var_Mul_Matrix([translation, rotMat, scaleMat])
    ...
    def glLoadModel(self, filename, textureName, textureName1=None, translate = (0,0,0), rotate = (0,0,0), scale = (1,1,1)):
