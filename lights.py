...
def refractVector(normal, incident, n1, n2):
    ...
    temp1 = ml.vecMultEsc(ml.twoVecSum(incident,ml.vecMultEsc(normal,c1)), n)
    temp2 = ml.vecMultEsc(normal, (1-n**2*(1-c1**2))**0.5)
    
    t = ml.twoVecSubstraction(temp1, temp2)
...
class DirectionalLight(Light):
    ...
    def getDiffuseColor(self, intercept):
        ...
        intensity = ml.twoVecDot(intercept.normal, dir) * self.intensity
    ...
    def getSpecularColor(self, intercept, viewPos):
        ...
        viewDir = ml.twoVecSubstraction(viewPos,intercept.point)
        viewDir = ml.vecNorm(viewDir)
        
        #Cambia dependiendo de la superficie
        specIntensity = max(0, ml.twoVecDot(viewDir, reflect))** intercept.obj.material.spec
...
class PointLight(Light):
    ...
    def getDiffuseColor(self, intercept):
        dir = ml.twoVecSubstraction(self.point, intercept.point)
        R = ml.vecNorm(dir)
        dir = dir/R
